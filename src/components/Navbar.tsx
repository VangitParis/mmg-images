  ...
  return (
    <motion.nav
      ...
      className={`sticky top-0 z-50 backdrop-blur-md border-b transition-all duration-500 ${
        scrolled
          ? "bg-neutral-950/90 border-neutral-800 shadow-[0_0_20px_rgba(0,0,0,0.3)]"
    ...
    >
      <div className="mx-auto max-w-7xl px-4 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex gap-6 text-sm text-neutral-300">
          ...
          {/* Affiche "À propos" seulement si la page existe */}
          {hasAbout && (
      ...
      <AnimatePresence>
        {menuOpen && (
          <motion.div
            ...
            className="fixed inset-0 bg-black/70 backdrop-blur-md z-40 flex justify-end"
          ...
          >
            <motion.div
              ...
              className="w-64 bg-neutral-950 border-l border-neutral-800 p-6 flex flex-col space-y-6"
              onClick={(e) => e.stopPropagation()}
            >
              <div className="text-lg font-medium text-white border-b border-neutral-800 pb-4">
                Menu
              </div>
              <button
                onClick={() => handleNav("gallery")}
                className="text-neutral-300 hover:text-amber-400 text-left"
              >
                Galerie
              </button>
